...
const updateCartItem = (item: CartItem, updateType: UpdateType): CartItem | null => {
...
export const CartProvider = ({
  ...
  const value = useMemo(() => ({ cart: optimisticCart, updateCartItem, addCartItem }), [optimisticCart]);
